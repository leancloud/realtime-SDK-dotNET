...
{
    public abstract class AVIMQueryBase<T>
    {
        ...
        protected AVIMQueryBase()
        {

        }

        internal abstract AVIMQueryBase<T> CreateInstance(AVIMQueryBase<T> source,
        ...
        protected AVIMQueryBase(AVIMQueryBase<T> source,
            IDictionary<string, object> where = null,
            IEnumerable<string> replacementOrderBy = null,
            IEnumerable<string> thenBy = null,
            int? skip = null,
        ...
        public AVIMQueryBase(string className)
        {
            if (className == null)
            {
        ...
        public virtual AVIMQueryBase<T> OrderBy(string key)
        {
        ...
        /// <param name="key">The key to order by.</param>
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> OrderByDescending(string key)
        {
            return CreateInstance(this, replacementOrderBy: new List<string> { "-" + key });
        }
        ...
        /// <param name="key">The key to order by.</param>
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> ThenBy(string key)
        {
        ...
        /// <param name="key">The key to order by.</param>
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> ThenByDescending(string key)
        {
            return CreateInstance(this, thenBy: new List<string> { "-" + key });
        }
        ...
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> Include(string key)
        {
        ...
        /// <param name="key">The key that should be included.</param>
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> Select(string key)
        {
        ...
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> Skip(int count)
        {
        ...
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> Limit(int count)
        {
            return CreateInstance(this, limit: count);
        }

        internal virtual AVIMQueryBase<T> RedirectClassName(String key)
        {
        ...
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> WhereContainedIn<TIn>(string key, IEnumerable<TIn> values)
        {
        ...
        /// <param name="values">The values that will match.</param>
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> WhereContainsAll<TIn>(string key, IEnumerable<TIn> values)
        {
            return CreateInstance(this, where: new Dictionary<string, object> {
        ...
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> WhereContains(string key, string substring)
        {
            return CreateInstance(this, where: new Dictionary<string, object> {
        ...
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> WhereDoesNotExist(string key)
        {
            return CreateInstance(this, where: new Dictionary<string, object>{
        ...
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> WhereDoesNotMatchQuery<TOther>(string key, AVQuery<TOther> query)
        ...
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> WhereEndsWith(string key, string suffix)
        {
            return CreateInstance(this, where: new Dictionary<string, object> {
        ...
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> WhereEqualTo(string key, object value)
        {
            return CreateInstance(this, where: new Dictionary<string, object> {
                { key, value}
            });
        ...
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> WhereSizeEqualTo(string key, uint size)
        {
            return CreateInstance(this, where: new Dictionary<string, object> {
        ...
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> WhereExists(string key)
        {
            return CreateInstance(this, where: new Dictionary<string, object>{
        ...
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> WhereGreaterThan(string key, object value)
        {
            return CreateInstance(this, where: new Dictionary<string, object>{
        ...
        /// <param name="value">The value that provides a lower bound.</param>
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> WhereGreaterThanOrEqualTo(string key, object value)
        {
            return CreateInstance(this, where: new Dictionary<string, object>{
        ...
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> WhereLessThan(string key, object value)
        {
            return CreateInstance(this, where: new Dictionary<string, object>{
        ...
        /// <param name="value">The value that provides a lower bound.</param>
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> WhereLessThanOrEqualTo(string key, object value)
        {
            return CreateInstance(this, where: new Dictionary<string, object>{
        ...
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> WhereMatches(string key, Regex regex, string modifiers)
        {
        ...
        /// have the <see cref="RegexOptions.ECMAScript"/> options flag set.</param>
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> WhereMatches(string key, Regex regex)
        {
        ...
        /// <code>m</code> Search across multiple lines of input</param>
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> WhereMatches(string key, string pattern, string modifiers = null)
        {
        ...
        /// <param name="pattern">The PCRE regular expression pattern to match.</param>
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> WhereMatches(string key, string pattern)
        {
        ...
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> WhereMatchesKeyInQuery<TOther>(string key,
          string keyInQuery,
        ...
        /// <param name="query">The subquery to run</param>
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> WhereDoesNotMatchesKeyInQuery<TOther>(string key,
          string keyInQuery,
          AVQuery<TOther> query) where TOther : AVObject
        {
            var parameters = new Dictionary<string, object> {
        ...
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> WhereMatchesQuery<TOther>(string key, AVQuery<TOther> query)
          where TOther : AVObject
        {
            return CreateInstance(this, where: new Dictionary<string, object> {
        ...
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> WhereNear(string key, AVGeoPoint point)
        {
            return CreateInstance(this, where: new Dictionary<string, object> {
        ...
        /// <param name="values">The values that will match.</param>
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> WhereNotContainedIn<TIn>(string key, IEnumerable<TIn> values)
        {
            return CreateInstance(this, where: new Dictionary<string, object> {
        ...
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> WhereNotEqualTo(string key, object value)
        {
            return CreateInstance(this, where: new Dictionary<string, object> {
        ...
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> WhereStartsWith(string key, string suffix)
        {
            return CreateInstance(this, where: new Dictionary<string, object> {
                { key, new Dictionary<string, object>{{"$regex", "^" + RegexQuote(suffix)}}}
            });
        ...
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> WhereWithinGeoBox(string key,
        ...
        /// <returns>A new query with the additional constraint.</returns>
        public virtual AVIMQueryBase<T> WhereWithinDistance(
            string key, AVGeoPoint point, AVGeoDistance maxDistance)
        {
            AVIMQueryBase<T> avQuery = this.WhereNear(key, point);
        ...
        internal virtual AVIMQueryBase<T> WhereRelatedTo(AVObject parent, string key)
        {
            return CreateInstance(this, where: new Dictionary<string, object> {
                {
                    "$relatedTo",
